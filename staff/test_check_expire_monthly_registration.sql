...
VALUES 
    ('veh1', 'wave', 'black', '29A-12345', 'vt1'),
    ('veh2', 'sirius', 'blue', '29B-67890', 'vt1');
...
-- Test Case 1: Valid - Move expired registrations
PRINT 'Test Case 1: Valid - Move expired registrations';
...
-- Test Case 2: Valid - No expired registrations
PRINT 'Test Case 2: Valid - No expired registrations';
EXEC dbo.sp_check_expired_monthly_registrations;
SELECT * FROM dbo.expire_monthly_registration WHERE id = 'amr2';
PRINT 'Test Case 2: SUCCESS - No new rows in expire_monthly_registration';
GO

-- Test Case 3: Valid - Empty active_monthly_registration table
PRINT 'Test Case 3: Valid - Empty active_monthly_registration table';
DELETE FROM dbo.active_monthly_registration;
EXEC dbo.sp_check_expired_monthly_registrations;
SELECT * FROM dbo.expire_monthly_registration WHERE id NOT IN ('amr1');
PRINT 'Test Case 3: SUCCESS - No new rows in expire_monthly_registration';
GO